...
var LS8 = ee.ImageCollection('LANDSAT/LC08/C01/T1_SR')//.filterDate("2020-06-01","2020-06-15")
var S2 = ee.ImageCollection('COPERNICUS/S2_SR')//.filterDate("2020-06-01","2020-06-15")
var LS_TOA = ee.ImageCollection('LANDSAT/LC08/C01/T1_TOA')//.filterDate("2020-06-01","2020-06-15")
var s1 =  ee.ImageCollection('COPERNICUS/S1_GRD')
			.filter(ee.Filter.listContains('transmitterReceiverPolarisation', 'VH'))
			.filter(ee.Filter.listContains('transmitterReceiverPolarisation', 'VV'))
			.filter(ee.Filter.eq('orbitProperties_pass', 'DESCENDING'))
			.filter(ee.Filter.eq('instrumentMode', 'IW'))//.filterDate("2020-05-01","2020-05-15")
...
/////////
var month_date = 5
var month_date_end = 5
var year_date = 2020
var year_date_end = 2020

var LS8_of_intrest = Rice_Extent_Mapper.Date_splitter.Date_splitter(LS8,month_date,month_date_end,year_date, year_date_end,ROI)
print("LS8_of_intrest", LS8_of_intrest)
var S2_of_intrest = Rice_Extent_Mapper.Date_splitter.Date_splitter(S2,month_date,month_date_end,year_date, year_date_end,ROI)
print("S2_of_intrest", S2_of_intrest)
var LS_TOA_of_intrest = Rice_Extent_Mapper.Date_splitter.Date_splitter(LS_TOA,month_date,month_date_end,year_date, year_date_end,ROI)
print("LS_TOA_of_intrest", LS_TOA_of_intrest)
var s1_of_intrest = Rice_Extent_Mapper.Date_splitter.Date_splitter(s1,month_date,month_date_end, year_date, year_date_end,ROI)
...
var list_year = [2020]//[2015, 2016, 2017, 2018, 2019, 2020]

var finalCollection =  ee.ImageCollection(Rice_Extent_Mapper.Time_Period_Selector.Time_Period_Selector(LS8, list_month, list_year, ROI)).sort('system:time_start')
print('finalCollection', finalCollection.limit(100))
...
Map.addLayer(table2,{},"rice points table")
var label = 'presence';
